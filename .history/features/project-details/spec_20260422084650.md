...
index.html and index.css pages that contains all the code for a functioning Projects page.
...
- A section element or article element dedicated to my github projects.
- A dedicated section for the coding languages that i have learned. mmdnd
